...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    if (currentComposite.children != nil) {
        NSArray *childrenComposite = [currentComposite.children allObjects];
        NSMutableArray *tempNameArray = [[NSMutableArray alloc] init];
        for (Composite *composite in childrenComposite) {
            [tempNameArray addObject:composite.name];
        }
        NSPredicate *predicate = [NSPredicate predicateWithFormat:@"name = %@" ,tempNameArray];
